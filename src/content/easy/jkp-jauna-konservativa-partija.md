...
Mūsu sauklis ir: Godīgi! Drosmīgi! Gudri!

## Ko mēs gribam panākt?

Latvijai vajag attīstības plānu ilgam laikam.

Plāna pamats ir drošība, ekonomikas izaugsme, stipras ģimenes un attīstīti reģioni.

Mūsu mērķis ir droša un pārtikusi valsts.

Mēs gribam valsti, kurā cilvēki vēlas dzīvot, strādāt un audzināt bērnus.

## Kā mēs sargāsim Latviju?

- Veidosim modernu valsts aizsardzības sistēmu. Latvija pati spēs novērst draudus un atturēt uzbrucēju.
...
## Kā mēs rūpēsimies par drošību valstī?

- Gatavosim sabiedrību ārkārtas situācijām. Kopienas apgūs civilās aizsardzības prasmes.
- Iestāsimies par stingru un kontrolētu imigrācijas politiku. Iebraucējiem būs augstas prasības iekļauties sabiedrībā. Pirmajā vietā būs Latvijas ilgtermiņa intereses.
- Stiprināsim Valsts robežsardzi. Attīstīsim robežas kontroles tehnoloģijas, novērošanas sistēmas un darba spējas.
- Prasīsim civilās aizsardzības sistēmas reformu. Būs viena vadība ar skaidru atbildību. Būs vienots patvertņu saraksts visai valstij. Krīzes vadīs saskaņoti un efektīvi.
- Iestāsimies par to, lai policija pastāvīgi ir klāt reģionos. Veidosim reģionālos drošības centrus. Katrs centrs atbildēs par savu teritoriju. Centri ātri reaģēs uz draudiem.
- Uzlabosim noziegumu izmeklēšanu pirms tiesas. Stiprināsim ekspertīžu iespējas. Krimināllietas izskatīs ātrāk.
- Aicināsim veidot brīvprātīgo drošības vienības kopienās. Vienības palīdzēs policijai, civilajai aizsardzībai un krīžu pārvaldībai.
...
- Veidosim efektīvu un profesionālu valsts pārvaldi, kas strādā uz rezultātu. Mazināsim birokrātiju. Izvērtēsim iestāžu funkcijas, iespējas iestādes apvienot un vajadzīgās reformas.
...
- Iestāsimies par kvalitatīvu izglītību visā Latvijā. Izglītība atbildīs darba tirgus vajadzībām. Vispirms stiprināsim matemātikas, dabaszinātņu un tehnoloģiju apguvi.
- Mazināsim birokrātiju skolotājiem. Stiprināsim skolotāju profesionālo patstāvību.
- Veidosim ilgtermiņā prognozējamu skolotāju algu sistēmu. Algas pakāpeniski augs. Īpaši novērtēsim skolotāja darba stāžu un profesionālo pieredzi.
- Uzlabosim skolotāju sociālās garantijas. Izvērtēsim iespēju saistīt pensionēšanās nosacījumus ar darba stāžu.
- Atbalstīsim stabilu naudu zinātniekiem pēc doktora grāda iegūšanas. Atbalstīsim jauno zinātnieku izaugsmi. Tā mazināsim talantīgu pētnieku aizbraukšanu no Latvijas.
- Prasīsim augstāku kvalitāti pētījumiem, ko apmaksā valsts. Pētījumiem jābūt noderīgiem. Valsts naudu izmantos atbildīgi.
- Veicināsim darba devēju iesaisti profesionālajā izglītībā un audzēkņu praksēs.
- Celsim profesionālās izglītības prestižu. Profesionālā izglītība palīdzēs ekonomikas attīstībai. Pārskatīsim arī profesionālās izglītības finansēšanas kārtību.

## Kā mēs stiprināsim valodu, kultūru un sportu?

- Stiprināsim latviešu valodas lomu izglītībā, publiskajā telpā un valsts pārvaldē.
- Veidosim valsts programmu latviskās lauku ainavas atjaunošanai. Atbalstīsim mājokļu būvniecību tradicionālā arhitektūrā. Atbalstīsim vēsturisko lauku ēku atjaunošanu.
- Atbalstīsim lielāku valsts iesaisti reģionu vecpilsētu saglabāšanā. Mazināsim birokrātiju namu atjaunošanai.
- Atbalstīsim valsts iesaisti Latvijas kultūras mantojuma un rūpniecības mantojuma saglabāšanā. Sargāsim arī valstij nozīmīgus zīmolus.
- Atbalstīsim iedzīvotāju iesaisti kultūras mantojuma saglabāšanā. Atbalstīsim privāto kolekcionāru iniciatīvas un muzeju attīstību.
- Aizstāvēsim taisnīgākas un salīdzināmas algas kultūras darbiniekiem valsts un pašvaldību kultūras iestādēs.
- Atbalstīsim taisnīgāku un atklātāku sporta finansēšanas sistēmu.
